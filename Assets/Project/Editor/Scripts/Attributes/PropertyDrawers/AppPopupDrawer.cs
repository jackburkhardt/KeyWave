...
[CustomPropertyDrawer(typeof(SmartWatchAppPopupAttribute))]
public class SmartWatchAppPopupDrawer : PropertyDrawer
{
    ...
    private string filter = string.Empty;
     ...
     public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        ...
        public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
        {
            ...
            showReferenceDatabase = (attribute as SmartWatchAppPopupAttribute).showReferenceDatabase;
            showFilter = (attribute as SmartWatchAppPopupAttribute).showFilter;
        ...
        public void UpdateTitles(string currentItem, string filter)
        {
            ...
            {
                var apps = titlesDatabase.items.Where(p => p.IsApp).ToList();
