...
namespace Project.Runtime.Scripts.ActorCompendium
{
    ...
    /// Other scripts such as ActorStateListener can specify their indicator level. This script then shows the
    /// GameObject of the highest indicator level that's in use.
    /// </summary>
    [AddComponentMenu("")] // Use wrapper.
    public class ActorStateIndicator : MonoBehaviour
    {
        ...
        private List<List<ActorStateListener>> m_currentIndicatorCount = new List<List<ActorStateListener>>();
        ...
        private void InitializeCurrentIndicatorCount()
        {
            ...
            {
                m_currentIndicatorCount.Add(new List<ActorStateListener>());
            }
        }

        public void SetIndicatorLevel(ActorStateListener listener, int indicatorLevel)
        {
