...
namespace Apps
{
    public class EmailBackend : ScriptableObject
    {
        ...
        public void Awake()
        {
            emailsPath =  $"{Application.dataPath}/Resources/GameData/Emails/";
            inboxPath = $"{Application.dataPath}/Resources/GameData/Emails/inbox.json";
        ...
        private void Save() => DataManager.SerializeList(playerInbox, inboxPath);
        public static void Load() => playerInbox = DataManager.DeserializeList<List<Email>>(inboxPath);
